...
public class FormAlternativad extends JDialog{
	...
	public FormAlternativad(Alternativa alt, DefaultTreeModel fact) {
		super();
		alternativa = alt;
		factores = fact;
		initialize();
	...
	public FormAlternativad(Frame owner, Alternativa alt,DefaultTreeModel fact) {
		super(owner);
		alternativa = alt;
		factores = fact;
		initialize();
